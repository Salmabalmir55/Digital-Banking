package net.balmir.ebankingbackend;

import net.balmir.ebankingbackend.dtos.BankAccountDTO;
import net.balmir.ebankingbackend.dtos.CurrentBankAccountDTO;
import net.balmir.ebankingbackend.dtos.CustomerDTO;
import net.balmir.ebankingbackend.dtos.SavingBankAccountDTO;
...
public class EbankingBackendApplication {
    ...
    CommandLineRunner commandLineRunner(BankAccountService bankAccountService) {
        return args -> {
            Stream.of("Amina", "Mustapha", "ElMehdi").forEach(name -> {
    ...
    CommandLineRunner start(CustomerRepository customerRepository,
        ...
        return args -> {
            Stream.of("Salma", "Meriem", "Ayoub").forEach(name -> {
            ...
            for (BankAccount acc : bankAccountRepository.findAll()) {
                for (int i = 0; i < 10; i++) {
